...
const CreatePin = ({ user }) => {
	...
	const [btnTitle, setBtnTitle] = useState('Save Pin');
			...
			<div className=' flex flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5  w-full'>
							...
							<label>
								<div className='flex flex-col items-center justify-center h-full'>
									<div className='flex flex-col items-center justify-center'>
										...
										<p className='font-bold text-lg'>Click here to upload</p>
									</div>
									<p className='mt-32 text-gray-400'>
										Use high-quality JPG, SVG, PNG, GIF, less thean 20 MB
									</p>
								</div>
				...
				<div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
					<input
						...
						className='outline-none text-gray-700 text-2xl sm:text-3xl font-bold border-b-2 border-gray-200 p-2'
					/>
					{user && (
					...
					<input
						...
						className='outline-none text-gray-700 text-base sm:text-lg border-b-2 border-gray-200 p-2'
					/>
					<input
						type='url'
						vlaue={destination}
					...
					<div className='flex flex-col'>
						<p className='mb-2 font-semibold text-lg text-gray-700 sm:text-xl'>
							Choose Pin Category
						</p>
						<select
